...
5. В строке заголовка плейера, кроме имени плейера должно отображаться название композиции;
6. Добавить кнопку 'Mute', которая полностью отключает и включает звук;
